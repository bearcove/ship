...
export function useModelPicker(sessionId: string, agent: AgentSnapshot) {
  ...
  return { parsed, handleSelectModel, handleSelectModelName, handleSelectEffort };
}
...
export function AgentModelPicker({
  ...
  const { parsed, handleSelectModel, handleSelectModelName, handleSelectEffort } = useModelPicker(
    sessionId,
    agent,
  );
