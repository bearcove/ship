...
const blocks: BlockEntry[] = [
  { blockId: "text-1", role: { tag: "Captain" }, block: { tag: "Text", text: "Feed update one." } },
  {
    ...
    block: {
      tag: "PlanUpdate",
      steps: [{ description: "Outdated plan step", status: { tag: "Planned" } }],
    },
  },
  { blockId: "text-2", role: { tag: "Captain" }, block: { tag: "Text", text: "Feed update two." } },
  {
    ...
    block: {
      tag: "PlanUpdate",
      steps: [
        { description: "Queue the UI patch", status: { tag: "Planned" } },
        { description: "Render the sticky plan", status: { tag: "InProgress" } },
        { description: "Ship the component tests", status: { tag: "Completed" } },
        { description: "Handle regressions", status: { tag: "Failed" } },
      ],
    },
  },
];
