...
export type WorkflowMilestoneKind =
  | { tag: 'PlanSet' }
  | { tag: 'StepCommitted' }
  | { tag: 'ReviewSubmitted' }
  | { tag: 'RebaseConflict' }
...
export type ContentBlock =
  ...
  | { tag: 'Image'; mime_type: string; data: Uint8Array }
  | { tag: 'WorkflowMilestone'; kind: WorkflowMilestoneKind; title: string; summary: string; items: string[]; commits: CommitSummary[]; stats: TaskRecapStats | null }
...
export type SessionEvent =
  ...
  | { tag: 'BlockFinalized'; block_id: BlockId; role: Role; text: string }
...
export type GlobalEvent =
  ...
  | { tag: 'Activity'; entry: ActivityEntry };
...
export type GetNewSessionDefaultsRequest = [];
export type GetNewSessionDefaultsResponse = NewSessionDefaults | null;
...
export interface ShipCaller {
  ...
  getNewSessionDefaults(): CallBuilder<NewSessionDefaults | null>;
...
export class ShipClient implements ShipCaller {
  ...
  getNewSessionDefaults(): CallBuilder<NewSessionDefaults | null> {
    ...
    return new CallBuilder(async (metadata) => {
      const value = await this.caller.call({
        method: "Ship.getNewSessionDefaults",
        args: {},
        descriptor,
        schemaRegistry: ship_descriptor.schema_registry,
        metadata,
      });
      return value as NewSessionDefaults | null;
    });
  }
...
export interface ShipHandler {
  ...
  getNewSessionDefaults(): Promise<NewSessionDefaults | null> | NewSessionDefaults | null;
...
export class ShipDispatcher implements ChannelingDispatcher {
  ...
  async dispatch(method: MethodDescriptor, args: unknown[], call: RoamCall): Promise<void> {
    if (method.id === 0x22e89bd72c12574bn) {
    ...
    } else if (method.id === 0xa750e656155a9c99n) {
      try {
        const result = await this.handler.getNewSessionDefaults();
        call.reply(result);
      } catch {
        call.replyInternalError();
      }
      ...
      try {
        const result = await this.handler.steer(args[0] as SessionId, args[1] as PromptContentPart[]);
        call.reply(result);
      } catch {
        call.replyInternalError();
      }
      ...
      try {
        const result = await this.handler.promptCaptain(args[0] as SessionId, args[1] as PromptContentPart[]);
        call.reply(result);
      } catch {
        call.replyInternalError();
      }
      ...
      try {
        const result = await this.handler.setAgentModel(args[0] as SessionId, args[1] as Role, args[2] as string);
        call.reply(result);
      } catch {
        call.replyInternalError();
      }
      ...
      try {
        const result = await this.handler.listWorktreeFiles(args[0] as SessionId, args[1] as string);
        call.reply(result);
      } catch {
        call.replyInternalError();
      }
    ...
    } else if (method.id === 0x43a4a9e7dd425937n) {
      try {
...
const ship_schema_registry: SchemaRegistry = new Map<string, Schema>([
  ...
  ["HumanReviewRequest", { kind: 'struct', fields: { 'message': { kind: 'string' }, 'diff': { kind: 'string' }, 'worktree_path': { kind: 'string' } } }],
  ["AgentAcpInfo", { kind: 'struct', fields: { 'acp_session_id': { kind: 'string' }, 'was_resumed': { kind: 'bool' }, 'protocol_version': { kind: 'u16' }, 'agent_name': { kind: 'option', inner: { kind: 'string' } }, 'agent_version': { kind: 'option', inner: { kind: 'string' } }, 'cap_load_session': { kind: 'bool' }, 'cap_resume_session': { kind: 'bool' }, 'cap_prompt_image': { kind: 'bool' }, 'cap_prompt_audio': { kind: 'bool' }, 'cap_prompt_embedded_context': { kind: 'bool' }, 'cap_mcp_http': { kind: 'bool' }, 'cap_mcp_sse': { kind: 'bool' }, 'last_event_at': { kind: 'option', inner: { kind: 'string' } } } }],
  ["SessionDetail", { kind: 'struct', fields: { 'id': { kind: 'string' }, 'slug': { kind: 'string' }, 'project': { kind: 'string' }, 'branch_name': { kind: 'string' }, 'title': { kind: 'option', inner: { kind: 'string' } }, 'captain': { kind: 'ref', name: 'AgentSnapshot' }, 'mate': { kind: 'ref', name: 'AgentSnapshot' }, 'startup_state': { kind: 'ref', name: 'SessionStartupState' }, 'current_task': { kind: 'option', inner: { kind: 'ref', name: 'TaskRecord' } }, 'task_history': { kind: 'vec', element: { kind: 'ref', name: 'TaskRecord' } }, 'autonomy_mode': { kind: 'ref', name: 'AutonomyMode' }, 'pending_steer': { kind: 'option', inner: { kind: 'string' } }, 'pending_human_review': { kind: 'option', inner: { kind: 'ref', name: 'HumanReviewRequest' } }, 'created_at': { kind: 'string' }, 'user_avatar_url': { kind: 'option', inner: { kind: 'string' } }, 'captain_acp_info': { kind: 'option', inner: { kind: 'ref', name: 'AgentAcpInfo' } }, 'mate_acp_info': { kind: 'option', inner: { kind: 'ref', name: 'AgentAcpInfo' } } } }],
...
export const ship_descriptor: ServiceDescriptor = {
  ...
  methods: [
    ...
    },
    {
      ...
      args: { kind: 'tuple', elements: [] },
      result: { kind: 'enum', variants: [{ name: 'Ok', fields: { kind: 'ref', name: 'ServerInfo' } }, { name: 'Err', fields: { kind: 'enum', variants: [{ name: 'User', fields: null }, { name: 'UnknownMethod', fields: null }, { name: 'InvalidPayload', fields: null }, { name: 'Cancelled', fields: null }] } }] },
    },
    {
      name: 'getNewSessionDefaults',
      id: 0xa750e656155a9c99n,
      args: { kind: 'tuple', elements: [] },
      result: { kind: 'enum', variants: [{ name: 'Ok', fields: { kind: 'option', inner: { kind: 'ref', name: 'NewSessionDefaults' } } }, { name: 'Err', fields: { kind: 'enum', variants: [{ name: 'User', fields: null }, { name: 'UnknownMethod', fields: null }, { name: 'InvalidPayload', fields: null }, { name: 'Cancelled', fields: null }] } }] },
    },
    {
      name: 'getSession',
    ...
    },
    {
      ...
      args: { kind: 'tuple', elements: [{ kind: 'string' }, { kind: 'vec', element: { kind: 'ref', name: 'PromptContentPart' } }] },
    ...
    },
    {
      ...
      result: { kind: 'enum', variants: [{ name: 'Ok', fields: { kind: 'ref', name: 'SetAgentEffortResponse' } }, { name: 'Err', fields: { kind: 'enum', variants: [{ name: 'User', fields: null }, { name: 'UnknownMethod', fields: null }, { name: 'InvalidPayload', fields: null }, { name: 'Cancelled', fields: null }] } }] },
    },
    {
      name: 'closeSession',
    ...
    },
    {
      ...
      result: { kind: 'enum', variants: [{ name: 'Ok', fields: { kind: 'ref', name: 'ArchiveSessionResponse' } }, { name: 'Err', fields: { kind: 'enum', variants: [{ name: 'User', fields: null }, { name: 'UnknownMethod', fields: null }, { name: 'InvalidPayload', fields: null }, { name: 'Cancelled', fields: null }] } }] },
    },
    {
