...
const ship_schema_registry: SchemaRegistry = new Map<string, Schema>([
  ...
  ["TaskId", { kind: 'string' }],
  ["TaskRecord", { kind: 'struct', fields: { 'id': { kind: 'string' }, 'title': { kind: 'string' }, 'description': { kind: 'string' }, 'status': { kind: 'ref', name: 'TaskStatus' }, 'assigned_at': { kind: 'option', inner: { kind: 'string' } }, 'completed_at': { kind: 'option', inner: { kind: 'string' } } } }],
